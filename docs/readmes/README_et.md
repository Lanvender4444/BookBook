...
## Kiire Käivitamise Skriptid (Windows)

### Backend Käivitamine Ühe Kliki Ga

Loo `start_backend.bat`:
```batch
@echo off
cd backend
uv run uvicorn main:app --reload --port 8000
...
### Frontend Käivitamine Ühe Kliki Ga

Loo `start_frontend.bat`:
```batch
@echo off
cd frontend
npm run dev
...
### Kõigi Teenuste Käivitamine Ühe Kliki Ga
